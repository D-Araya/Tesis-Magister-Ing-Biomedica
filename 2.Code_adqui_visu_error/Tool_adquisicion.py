...
class SampleListener(Leap.Listener):
    ...
    def on_frame(self, controller):
        ...
        for tools in frame.tools:
            ...
            direc = tools.direction.to_float_array()
            self.Tool.append(ToolTip)
            #
            # print ToolTip, tools.direction.yaw * Leap.RAD_TO_DEG, len(frame.tools)
            time.sleep(0.02)

            times = tools.time_visible
        ...
        for hand in frame.hands:
            ...
            #Middle = Leap.Vector(x3, y3, z3).to_float_array()
