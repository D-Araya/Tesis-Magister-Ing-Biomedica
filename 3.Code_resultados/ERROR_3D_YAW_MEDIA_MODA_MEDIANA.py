...
#"""
rot = np.identity(4)
#tethaY = math.radians(0)
#tethaY = math.radians(int(media))   # ANGULO EN GRADOS --> -10, -15, -20 o -30
#tethaY = math.radians(int(moda[0]))
tethaY = math.radians(int(mediana))
#tethaY = math.radians(int(media1))
#tethaY = math.radians(int(moda1[0]))
#tethaY = math.radians(int(mediana1))
