...
#datas = np.loadtxt(r'C:\Users\Casa\PycharmProjects\Leap with Python\signal\datosEspiral\2-ESPIRALconZ\20yaw\2_20yaw.csv', delimiter=',', unpack=True)
datas = np.loadtxt(r'C:\Users\Casa\PycharmProjects\Leap with Python\signal\EstudioDeCaso\3.csv', delimiter=',', unpack=True)
...
#print "Media Yaw: %f" % (mean_yaw)
######## MATRIZ DE ROTACION - TRANSFORMACION AFFINE   -- PITCH
rot = np.identity(4)
tethaP = math.radians(-19)   # ANGULO EN GRADOS --> -10, -15, -20 o -30
...
#print pts
"""
######## MATRIZ DE ROTACION - TRANSFORMACION AFFINE   -- YAW
rot = np.identity(4)
tethaY = math.radians(-12)   # ANGULO EN GRADOS --> -10, -15, -20 o -30
