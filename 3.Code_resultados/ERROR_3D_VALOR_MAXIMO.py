...
data = np.loadtxt(r'C:\Users\Casa\PycharmProjects\Leap with Python\signal\datosEspiral\1-ESPIRALsinZ\espiral_1\1_espiral_1.csv', delimiter=',', unpack=True)
...
rot = np.identity(4)
tethaY = math.radians(-20)   # ANGULO EN GRADOS --> -10, -15, -20 o -30
